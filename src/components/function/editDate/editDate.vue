    ...
    data(){
        return{
			...
			levelBtn:[{
				text:"重要",
				color:"#ef7676",
				desc:"这一天发生了一件重要的事情，我很开心！！！"
			},{
				text:"比较重要",
				color:"#35b8f3",
				desc:"这一天发生了一件比较重要的事情，记一下吧！"
			},{
				text:"普普通通",
				color:"#9cff29",
				desc:"这一天发生了一件普普通通的事情，记个流水账~"
			},{
				text:"比较不重要",
				color:"#fed640",
				desc:"这一天发生了一件比较不重要的事情，那我记它干嘛？"
			},{
				text:"不重要",
				color:"#ccb7af",
				desc:"这一天发生了一件不重要的事情，算了不想吐槽！"
			}],
			selectIndex:0
        }
    },
